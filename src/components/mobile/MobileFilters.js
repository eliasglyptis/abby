...
export default function MobileFilters({ packages, onPriceChange, closeModal }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 lg:hidden">
      <div className="bg-white w-[312px] p-4 shadow-md border border-stroke rounded-lg relative">
        <button onClick={closeModal} className="absolute top-4 right-4 text-black">
          ✕
        </button>
        <h2 className="text-h5 font-bold mb-8">Φίλτρα</h2>
        <div className="mb-6">
          <h3 className="text-h7 font-bold mb-8">Εύρος Τιμής</h3>
